...
<?php
    ...
    <iframe src="header.php" frameborder="0" width="500" height="200"></iframe>
    <br><button><a href="#otid"> Browse</a></button></h1>
        ...
        <div class="row">
            ...
            <div class="col-md-3 ano-to">
                <div class="list-group search-box1">
                    <input id="search" class="search-txt1" type="text" name="search" placeholder="Type to search">
				...
				<div class="list-group">
					<h3>Price</h3>
					<input class="price" type="hidden" id="hidden_minimum_price" value="0" />
                    <input class="price" type="hidden" id="hidden_maximum_price" value="100000" />
                ...
                <div class="list-group"><br>
                    ...
                    $query = $conn->query("SELECT DISTINCT(artGenre) FROM sining_artworks WHERE product_status = '1' ORDER BY artId DESC");
