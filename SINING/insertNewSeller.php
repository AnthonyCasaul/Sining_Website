...
$approved = mysqli_query($conn, "SELECT * FROM sining_seller_approval WHERE seller_id ='$seller_id'");
 ...
 $query = mysqli_query($conn, "INSERT INTO sining_sellers (artistId, seller_name, seller_username, seller_address, seller_contact, seller_email, seller_profile,seller_gcash) VALUES('$user_id', '$fullname', '$username', '$address', '$contact', '$email', '$profile', '$qr')");
