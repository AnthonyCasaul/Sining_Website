...
$pending_payment = mysqli_query($conn, "SELECT * FROM product_status WHERE seller_id = '$seller_id' AND product_status = 'To pay'");
?>
...
<?php
      if(mysqli_num_rows($pending_payment) > 0){
			    while($row = mysqli_fetch_assoc($pending_payment)){
